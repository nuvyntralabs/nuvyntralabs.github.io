...
| `/toolkits/` | Developer toolkits (Nuvyn spec CLI, MauiDev doctor, NuvLoc localization, Pulse session viewer) |
| `/toolkits/nuvyn/` | Nuvyn 1.2.0 overview — spec-driven MAUI host; nuvyn adopt for existing apps |
