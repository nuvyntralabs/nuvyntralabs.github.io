...
export const packages: PackageDoc[] = [
  ...
  },
  {
    ...
    "description": "A modular MVVM framework for .NET MAUI: observable models, async commands, bindable AsyncState, lifecycle-aware cancellation, typed Shell or page navigation, dialogs, toast, validation, and pagination. Public preview 0.3.0 — APIs may still change.",
