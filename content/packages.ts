...
export const packages: PackageDoc[] = [
  ...
  },
  {
    ...
    "description": "A modular MVVM framework for .NET MAUI: observable models, async commands, bindable AsyncState, lifecycle-aware cancellation, typed Shell or page navigation, dialogs, toast, validation, pagination, forms, Reactive, and source generators. Public preview 0.6.0 — device-safe marshal, weak CanExecuteChanged, Window.AddOverlay toasts. 1.0.0 waits on design-review sign-off.",
    ...
    "capabilities": [
      ...
      "FormViewModel dirty confirm, SubmitAsync, FormField.Error / HasError, MustMatch, undo/redo.",
      "UseMvvmExpress(o => o.UseShell().UseDialogs()), auto lifecycle, BusyOverlayBehavior, AsyncStateView.",
      ...
      "Validation DataAnnotations + MustMatch + ILLink trim roots; Reactive CombineLatest without System.Reactive.",
