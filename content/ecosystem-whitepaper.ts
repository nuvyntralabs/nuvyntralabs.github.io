    ...
    blocks: [
      {
        ...
        rows: [
          ...
          [
            "NuvLoc CLI 1.1.1",
            "`nuvloc init` checks `i18n.json` and installs `/nuvloc.status` + `/nuvloc.translate`. The agent translates sibling `.resx` files. No vendor API key. Not a PackageReference.",
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["Localize", "NuvLoc: `i18n.json` + `nuvloc init` + `/nuvloc.translate` for sibling `.resx`. Native-speaker review before ship. Completeness is not correctness."],
