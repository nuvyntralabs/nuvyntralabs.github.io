...
export const nuvexaDb = {
  ...
  releaseTag: "https://github.com/nuvyntralabs/NuvexaDB/releases/tag/v1.0.7",
...
export const nuvexaLayers = [
  ...
  { name: "CLI", project: "Nuventra.NuvexaDB.Cli", role: "PackAsTool nuvexa. Also bundled into the VS Code and Visual Studio VSIX" },
