...
| --- | --- |
| **`NuvexaDB-Swift-osx-arm64.zip`** | `nuvexadb-swift-1.0.5.tgz` (Package.swift + Sources) |
...
| **`NuvexaDB-Swift-osx-arm64.zip`** | Same Swift sources (`nuvexadb-swift-1.0.5.tgz`) |
...
Unpack `nuvexadb-swift-1.0.5.tgz`. In `Package.swift`:
