  ...
  if (slug === mvvmExpressSlug) {
    ...
    if (kind === "integration") {
      return {
        ...
        description:
          "From dotnet new mvvmexpress, a Marketplace IDE extension, or NuGet install to a testable ViewModel: 1.0.1 templates, first screen, UseNavigationPage vs UseShell, Playground clone, FakeNavigator / LeakProbe, forms, generators, and the in-repo sample map.",
